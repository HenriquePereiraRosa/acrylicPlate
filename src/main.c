...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define BSRR_VAL        0x0380
#define BSRR_LED_RED	0x0070
#define BSRR_LED_BLUE	0x0080
#define BSRR_LED_ORANGE 0x0100
#define BSRR_LED_GREEN  0x0200

#define BSRR_BT_USER  	0x0000
...
int main(void) {
	...
	uint8_t switch_key = 5, key_pressed = 0, pause = 0;
